 ...
 * @Generated
 */
define('ace/theme/model', ['require', 'exports', 'module' , 'ace/lib/dom'], function(require, exports, module) {

exports.isDark = false;
exports.cssText = ".ace-model .ace_gutter {\
	background: #ebebeb;\
...
.ace-model .ace_cursor {\
	border-left: 2px solid black;\
}\
.ace-model .ace_storage,\
.ace-model .ace_keyword,\
.ace-model .ace_variable {\
	font-weight: bold;\
	color: rgb(120, 0, 45);\
}\
.ace-model .ace_constant.ace_buildin {\
	color: rgb(88, 72, 246);\
}\
.ace-model .ace_constant.ace_library {\
	color: rgb(6, 150, 14);\
}\
.ace-model .ace_function {\
	color: rgb(60, 76, 114);\
}\
.ace-model .ace_string {\
	color: rgb(42, 0, 255);\
}\
.ace-model .ace_comment {\
	color: rgb(113, 150, 130);\
}\
.ace-model .ace_comment.ace_doc {\
	color: rgb(63, 95, 191);\
}\
.ace-model .ace_comment.ace_doc.ace_tag {\
	color: rgb(127, 159, 191);\
}\
.ace-model .ace_constant.ace_numeric {\
	color: darkblue;\
}\
.ace-model .ace_tag {\
...
.ace-model .ace_xml-pe {\
	color: rgb(104, 104, 91);\
}\
.ace-model .ace_marker-layer .ace_selection {\
	background: rgb(181, 213, 255);\
}\
.ace-model .ace_marker-layer .ace_bracket {\
	margin: -1px 0 0 -1px;\
	border: 1px solid rgb(192, 192, 192);\
}\
.ace-model .ace_meta.ace_tag {\
	color:rgb(25, 118, 116);\
}\
.ace-model .ace_invisible {\
	color: #ddd;\
}\
.ace-model .ace_entity.ace_other.ace_attribute-name {\
	color:rgb(127, 0, 127);\
}\
.ace-model .ace_marker-layer .ace_step {\
	background: rgb(255, 255, 0);\
}\
.ace-model .ace_marker-layer .ace_active-line {\
	background: rgb(232, 242, 254);\
}\
.ace-model .ace_marker-layer .ace_selected-word {\
	border: 1px solid rgb(181, 213, 255);\
}\
.ace-model .ace_indent-guide {\
